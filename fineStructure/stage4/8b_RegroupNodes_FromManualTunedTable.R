...
setwd("~/Documents/OtherCollaborations/RAICES/outputsFineStructure/stage4/")
...
tableTuned<-read.table("AllIter_OtherOrder_ManualTuning.txt",stringsAsFactors = F,header=T,sep="\t")
